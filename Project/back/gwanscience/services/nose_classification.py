...
# nose_length
nose_length_model_path = os.path.join(BASE_DIR, 'learning/classified/training_nose_length_logs/model_nose_length2.h5')
...
# nose_width
nose_width_model_path = os.path.join(BASE_DIR, 'learning/classified/training_nose_width_logs/model_nose_width2.h5')

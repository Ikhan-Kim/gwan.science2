...
def predict(filename):
    ...
    # lips_length
    lips_length_model_path = os.path.join(BASE_DIR, 'services/learning/classified/training_lips_length_logs/model_lips_length5.h5')
    ...
    lips_length = np.argmax(lips_length_classifications[0])



    # lips_thickness
    lips_thickness_model_path = os.path.join(BASE_DIR, 'services/learning/classified/training_lips_thickness_logs/model_lips_thickness1.h5')
    ...
    lips_thickness = np.argmax(lips_thickness_classifications[0])




    # mouth_tail
    mouth_tail_model_path = os.path.join(BASE_DIR, 'services/learning/classified/training_mouth_tail_logs/model_mouth_tail6.h5')
    ...
    mouth_tail = np.argmax(mouth_tail_classifications[0])

    data = [ lips_length, lips_thickness, mouth_tail ]

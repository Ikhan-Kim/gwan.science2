...
train_dir = os.path.join(LEARN_DIR, 'glabella_distance/train')
val_dir = os.path.join(LEARN_DIR, 'glabella_distance/validation')
...
plt.title('Glabella_distance Training and validation accuracy')
plt.legend(loc=0)
plt.figure()

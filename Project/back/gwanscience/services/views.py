...
@api_view(['GET'])
def face_reading_get(request,user_nickname, eyebrowInterval, eyeSize, eyeInterval, eyeTail, noseLength, noseWidth, mouthLength, mouthThickness, mouthTail):
    print('it works@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@')
    if eyebrowInterval == "넓은 미간":
        glabella_distance = 0
    elif eyebrowInterval == "미간 길이 평균":
        glabella_distance = 1
    elif eyebrowInterval == "짧은 미간":
        glabella_distance = 2

    if eyeSize == "큰 눈":
        eyes_size = 0
    elif eyeSize == "눈 크기 평균":
        eyes_size = 1
    elif eyeSize == "작은 눈":
        eyes_size = 2
    ...
    if eyeTail == "눈꼬리 내려감":
        ...
        eyes_tail = 1
    elif eyeTail == "눈꼬리 올라감":
        eyes_tail = 2

    if eyeInterval == "눈 사이가 멂":
        eyes_distance = 0
    elif eyeInterval == "눈 사이 거리 평균":
        eyes_distance = 1
    elif eyeInterval == "눈 사이 짧음":
        eyes_distance = 2

    if noseLength == "긴 코":
        nose_length = 0
    elif noseLength == "코 길이 보통":
        nose_length = 1
    elif noseLength == "짧은 코":
        nose_length = 2

    if noseWidth == "넓은 콧볼":
        nose_width = 0
    elif noseWidth == "콧볼 넓이 보통":
        nose_width = 1
    elif noseWidth == "좁은 콧볼":
        nose_width = 2

    if mouthLength == "긴 입술":
        lips_length = 0
    elif mouthLength == "입술 길이 보통":
        lips_length = 1
    elif mouthLength == "짧은 입술":
        lips_length = 2

    if mouthThickness == "두꺼운 입술":
        lips_thickness = 0
    elif mouthThickness == "입술 두께 보통":
        lips_thickness = 1
    elif mouthThickness == "얇은 입술":
        lips_thickness = 2

    if mouthTail == "입 꼬리 내려감":
        mouth_tail = 0
    elif mouthTail == "입 꼬리 보통":
        mouth_tail = 1
    elif mouthTail == "입 꼬리 올라감":
        mouth_tail = 2

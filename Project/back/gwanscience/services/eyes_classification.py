...
# eyes_size
eyes_size_model_path = os.path.join(BASE_DIR, 'learning/classified/training_eyes_size_logs/model_eyes_size3.h5')
...
# eyes_tail
eyes_tail_model_path = os.path.join(BASE_DIR, 'learning/classified/training_eyes_tail_logs/model_eyes_tail1.h5')
...
# eyes_distance
eyes_distance_model_path = os.path.join(BASE_DIR, 'learning/classified/training_eyes_distance_logs/model_eyes_distance1.h5')

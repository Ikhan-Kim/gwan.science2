...
def predict(filename):
    ...
    # glabella_distance
    glabella_distance_model_path = os.path.join(BASE_DIR, 'services/learning/classified/training_glabella_distance_logs/model_glabella_distance4.h5')
    ...
    glabella_distance = np.argmax(glabella_distance_classifications[0])

    data = [ glabella_distance ]
